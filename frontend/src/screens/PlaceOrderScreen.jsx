...
export default function PlaceOrderScreen(props) {
  ...
  const itemsPrice = cart.cartItems.reduce((accum, currItem) => accum + (currItem.qty * currItem.price), 0);

  cart.itemsPrice = toPrice(itemsPrice);
  ...
  const placeOrderHandler = () => {
    // TODO dispatch placeOrderHandler
  }
        ...
        <div className="col-1">
          <div className="card card-body">
            <ul>
              ...
              <li>
                <button type="button" onClick={placeOrderHandler} className="primary block" disabled={!cart.cartItems.length}>
                  Place order
                </button>
                <Link to="/">
